...
GeGeDe may be installed in any of the "usual" ways and in particular via [[https://docs.astral.sh/uv/][uv]].
...
See the [[./doc/install.org][installation]] document for details and other ways to install.
