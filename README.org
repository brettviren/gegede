...
The core of GeGeDe relies on [[https://github.com/hgrecco/pint][Pint]] to enforce the consistent use of units.  The =gegede= command line interface relies on [[http://click.pocoo.org/][Click]].
